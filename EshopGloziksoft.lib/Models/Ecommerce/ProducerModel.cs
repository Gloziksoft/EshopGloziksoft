...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class ProducerModel : _BaseModel
    {
        ...
        public void CopyDataFrom(EshopgloziksoftProducer src)
        {
            this.pk = src.pk;
        ...
        public void CopyDataTo(EshopgloziksoftProducer trg)
        {
            trg.pk = this.pk;
        ...
        public static ProducerModel CreateCopyFrom(EshopgloziksoftProducer src)
        {
        ...
        public static EshopgloziksoftProducer CreateCopyFrom(ProducerModel src)
        {
            EshopgloziksoftProducer trg = new EshopgloziksoftProducer();
            src.CopyDataTo(trg);
    ...
    public class ProducerPagingListModel : _PagingModel
    {
        ...
        public static ProducerPagingListModel CreateCopyFrom(Page<EshopgloziksoftProducer> srcArray)
        {
            ...
            foreach (EshopgloziksoftProducer src in srcArray.Items)
            {
    ...
    public class ProducerFilterModel : _BaseUserPropModel
    {
        ...
        public static ProducerFilterModel CreateCopyFrom(EshopgloziksoftUserProp src)
        {
        ...
        public static EshopgloziksoftUserProp CreateCopyFrom(ProducerFilterModel src)
        {
            src.UpdateAfterEdit();
    ...
    public class ProducerDropDown : CmpDropDown
    {
        ...
        public static ProducerDropDown CreateCopyFrom(Page<EshopgloziksoftProducer> dataList, bool allowNull, string emptyText)
        {
            ...
            foreach (EshopgloziksoftProducer dataItem in dataList.Items)
            {
