...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class CategoryModel : _BaseModel
    {
        ...
        public void CopyDataFrom(EshopgloziksoftCategory src)
        {
            if (src == null)
            {
                return;
        ...
        public void CopyDataTo(EshopgloziksoftCategory trg)
        {
            trg.pk = this.pk;
        ...
        public static CategoryModel CreateCopyFrom(EshopgloziksoftCategory src)
        {
        ...
        public static EshopgloziksoftCategory CreateCopyFrom(CategoryModel src)
        {
            EshopgloziksoftCategory trg = new EshopgloziksoftCategory();
            src.CopyDataTo(trg);
        ...
        public void LoadRelatives(EshopgloziksoftCategoryRepository repository)
        {
            this.Children = GetChildren(repository, this.pk);
            this.Parents = GetParents(repository, this.pk);
        }

        public static List<CategoryModel> GetChildren(EshopgloziksoftCategoryRepository repository, Guid categoryKey)
        {
            List<CategoryModel> dataList = new List<CategoryModel>();
            foreach (EshopgloziksoftCategory category in repository.GetRecordsForParent(categoryKey))
            {
        ...
        public static List<CategoryModel> GetParents(EshopgloziksoftCategoryRepository repository, Guid categoryKey)
        {
            List<CategoryModel> dataList = new List<CategoryModel>();
    ...
    public class CategoryTree
    {
        ...
        public CategoryTree()
        {
            ...
            List<EshopgloziksoftCategory> dataList = repository.GetPage(1, _PagingModel.AllItemsPerPage, Guid.Empty).Items;
        ...
        void ResolveTreeChildren(CategoryModel parent, List<EshopgloziksoftCategory> dataList)
        {
            parent.Children = new List<CategoryModel>();
            foreach (EshopgloziksoftCategory category in dataList)
            {
