...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class ProductPublicModel
    {
        ...
        public ProductPublicModel(string url)
        {
            ...
            EshopgloziksoftProduct product = rep.GetForProductUrl(url);
            ...
            if (product != null)
            {
                ...
                // Product category
                List<EshopgloziksoftProduct2Category> p2cDataList = new EshopgloziksoftProduct2CategoryRepository().GetForProduct(product.pk);
                if (p2cDataList != null && p2cDataList.Count > 0)
                {
                    EshopgloziksoftCategoryRepository categoryRep = new EshopgloziksoftCategoryRepository();
    ...
    public class ProductPublicImagesModel
    {
        ...
        {
            this.Items = new FileUploadRepository().GetFiles(EshopgloziksoftProduct.GetFileUploadCategory(productKey));
        }
    }
}
