...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    ...
    public class InsertProduct2QuoteModel
    {
        ...
        public static EshopgloziksoftProduct AddProductToQuote(Guid pkQuote, Guid pkProduct, decimal cnt)
        {
            // Get product
            EshopgloziksoftProductRepository prodRep = new EshopgloziksoftProductRepository();
            EshopgloziksoftProduct product = prodRep.Get(pkProduct);
            ...
            if (dataRec == null)
            {
                ...
                EshopgloziksoftProductPriceInfo productPrice = EshopgloziksoftProductPriceCache.GetProductPrice(dataRec.PkProduct);
