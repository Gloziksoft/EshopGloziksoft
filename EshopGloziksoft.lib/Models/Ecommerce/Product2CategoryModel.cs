...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class Product2CategoryModel : _BaseModel
    {
        ...
        public void CopyDataFrom(EshopgloziksoftProduct2Category src)
        {
            this.pk = src.pk;
        ...
        public static Product2CategoryModel CreateCopyFrom(EshopgloziksoftProduct2Category src)
        {
    ...
    public class Product2CategoryItemsModel : _PagingModel
    {
        ...
        public static Product2CategoryItemsModel CreateCopyFrom(Page<EshopgloziksoftProduct2Category> src)
        {
            Product2CategoryItemsModel trg = new Product2CategoryItemsModel();
            trg.Items = new List<Product2CategoryModel>();
            foreach (EshopgloziksoftProduct2Category srcItem in src.Items)
            {
        ...
        public static Product2CategoryItemsModel CreateCopyFrom(Guid categoryKey, Page<EshopgloziksoftProduct> src, ProductModelDropDowns productDropDowns)
        {
            Product2CategoryItemsModel trg = new Product2CategoryItemsModel();
            trg.Items = new List<Product2CategoryModel>();
            int i = 0;
            foreach (EshopgloziksoftProduct srcItem in src.Items)
            {
                trg.Items.Add(
        ...
        public void BindProducts(List<EshopgloziksoftProduct> products, ProductModelDropDowns productDropDowns)
        {
            Hashtable htProduct = new Hashtable(products.Count + 1);
            foreach (EshopgloziksoftProduct product in products)
            {
    ...
    public class ProductInCategoryFilterModel : _BaseUserPropModel
    {
        ...
        public static ProductInCategoryFilterModel CreateCopyFrom(EshopgloziksoftUserProp src)
        {
        ...
        public static EshopgloziksoftUserProp CreateCopyFrom(ProductInCategoryFilterModel src)
        {
            src.UpdateAfterEdit();
    ...
    public class ProductNotInCategoryFilterModel : _BaseUserPropModel
    {
        ...
        public static ProductNotInCategoryFilterModel CreateCopyFrom(EshopgloziksoftUserProp src)
        {
        ...
        public static EshopgloziksoftUserProp CreateCopyFrom(ProductNotInCategoryFilterModel src)
        {
            src.UpdateAfterEdit();
            EshopgloziksoftUserProp trg = new EshopgloziksoftUserProp();
            src.CopyDataTo(trg);
    ...
    public class Product2CategoryEditModel
    {
        ...
        public void LoadCategories(_BaseController ctrl, Guid productKey)
        {
            ...
            foreach (EshopgloziksoftProduct2Category dataRec in new EshopgloziksoftProduct2CategoryRepository().GetForProduct(productKey))
            {
