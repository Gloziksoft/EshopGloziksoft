...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class ProductModel : _BaseModel
    {
        ...
        public EshopgloziksoftProductPriceInfo PriceInfo { get; private set; }
        ...
        public void CopyDataFrom(EshopgloziksoftProduct src, ProductModelDropDowns dropDowns)
        {
        ...
        public void CopyDataTo(EshopgloziksoftProduct trg, ProductModelDropDowns dropDowns)
        {
            this.DropDowns = dropDowns;
        ...
        public static ProductModel CreateCopyFrom(EshopgloziksoftProduct src, ProductModelDropDowns dropDowns, bool loadPrice = false)
        {
            ProductModel trg = new ProductModel();
            trg.CopyDataFrom(src, dropDowns);
            if (loadPrice)
            {
                trg.PriceInfo = EshopgloziksoftProductPriceCache.GetProductPrice(trg.pk);
            }

            return trg;
        }

        public static EshopgloziksoftProduct CreateCopyFrom(ProductModel src, ProductModelDropDowns dropDowns)
        {
            EshopgloziksoftProduct trg = new EshopgloziksoftProduct();
    ...
    public class ProductSessionModel
    {
        public ProductSessionModel(ProductModel product, string sessionId)
        {
            ...
            this.MemberId = EshopgloziksoftCustomerCache.CurrentMemberId;
        }
    ...
    public class ProductDropDown : CmpDropDown
    {
        ...
        public static ProductDropDown CreateCopyFrom(Page<EshopgloziksoftProduct> dataList, bool allowNull, string emptyText)
        {
            ...
            foreach (EshopgloziksoftProduct dataItem in dataList.Items)
            {
    ...
    public class ProductPagingListModel : _PagingModel
    {
        ...
        public static ProductPagingListModel CreateCopyFrom(Page<EshopgloziksoftProduct> srcArray, ProductModelDropDowns dropDowns, bool loadPrices = false)
        {
            ...
            foreach (EshopgloziksoftProduct src in srcArray.Items)
            {
    ...
    public class ProductFilterModel : _BaseUserPropModel
    {
        ...
        public static ProductFilterModel CreateCopyFrom(EshopgloziksoftUserProp src)
        {
        ...
        public static EshopgloziksoftUserProp CreateCopyFrom(ProductFilterModel src)
        {
            src.UpdateAfterEdit();
    ...
    {
        EshopgloziksoftProductPriceComparer comparer = new EshopgloziksoftProductPriceComparer();
    ...
    {
        Hashtable ht;
        public ProductModelRecomendationComparer(EshopgloziksoftProductFilter filter)
        {
            List<EshopgloziksoftProduct2Category> dataList = new EshopgloziksoftProduct2CategoryRepository().GetList(new EshopgloziksoftProduct2CategoryFilter() { ProductCategoryKeyList = filter.ProductCategoryKeyList });
        ...
        {
            return ht.ContainsKey(product.pk) ? (ht[product.pk] as EshopgloziksoftProduct2Category).ProductOrder : 0;
        }
    ...
    public class ProductAttrHelper
    {
        ...
        void Reload()
        {
            if (htProductAttrStr.Count > 0)
            {
                ...
                List<EshopgloziksoftProduct2AttributeEx> dataList = new EshopgloziksoftProduct2AttributeRepository().GetForProducts(productKeyList);
                foreach (EshopgloziksoftProduct2AttributeEx dataRec in dataList)
                {
    ...
    public class ProductImagesModel : _BaseModel
    {
        ...
        public string FileUploadCategory
        {
            get
            {
                return EshopgloziksoftProduct.GetFileUploadCategory(this.pk);
            }
        }

        public static ProductImagesModel LoadModel(Guid productKey)
        {
            return LoadModel(ProductModel.CreateCopyFrom(new EshopgloziksoftProductRepository().Get(productKey), new ProductModelDropDowns()));
        }
        ...
        public void Save()
        {
            ...
            EshopgloziksoftProduct product = rep.Get(this.pk);
