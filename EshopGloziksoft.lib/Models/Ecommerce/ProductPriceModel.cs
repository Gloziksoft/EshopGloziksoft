...
namespace eshopgloziksoft.lib.Models.Ecommerce
{
    public class ProductPriceModel : _BaseModel
    {
        ...
        public void CopyDataFrom(EshopgloziksoftProductPrice src)
        {
            if (src == null)
            {
                return;
        ...
        public void CopyDataTo(EshopgloziksoftProductPrice trg)
        {
            trg.pk = this.pk;
        ...
        public static ProductPriceModel CreateCopyFrom(EshopgloziksoftProductPrice src)
        {
        ...
        public static EshopgloziksoftProductPrice CreateCopyFrom(ProductPriceModel src)
        {
            EshopgloziksoftProductPrice trg = new EshopgloziksoftProductPrice();
            src.CopyDataTo(trg);
    ...
    public class ProductPriceListModel : List<ProductPriceModel>
    {
        ...
        public static ProductPriceListModel CreateCopyFrom(List<EshopgloziksoftProductPrice> srcArray, bool standardPriceFirst = true)
        {
            ProductPriceListModel trgArray = new ProductPriceListModel();

            if (standardPriceFirst)
            {
                foreach (EshopgloziksoftProductPrice src in srcArray)
                {
                    if (src.ValidTo == null)
                    {
