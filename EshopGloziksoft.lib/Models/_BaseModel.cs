...
namespace eshopgloziksoft.lib.Models
{
    ...
    public class _BaseUserPropModel : _BaseModel
    {
        ...
        public void CopyDataFrom(EshopgloziksoftUserProp src)
        {
            this.pk = src.pk;
        ...
        public void CopyDataTo(EshopgloziksoftUserProp trg)
        {
            trg.pk = this.pk;
    ...
    public class _EshopgloziksoftViewPage : _SeoViewPage
    {
        public override void Execute()
        {
        }
