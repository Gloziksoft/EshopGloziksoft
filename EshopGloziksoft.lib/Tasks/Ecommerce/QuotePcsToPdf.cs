...
namespace eshopgloziksoft.lib.Tasks.Ecommerce
{
    public class QuotePcsListToPdf
    {
        ...
        public QuotePcsListToPdf(_BaseController ctrl)
        {
            ...
            QuoteListFilterModel filter = QuoteListFilterModel.CreateCopyFrom(new EshopgloziksoftUserPropRepository().Get(ctrl.CurrentSessionId, ConfigurationUtil.PropId_QuoteListFilterModel));
