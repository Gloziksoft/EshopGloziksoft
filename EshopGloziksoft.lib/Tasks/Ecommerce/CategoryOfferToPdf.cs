...
namespace eshopgloziksoft.lib.Tasks.Ecommerce
{
    public class CategoryOfferToPdf
    {
        ...
        private float PageHeader(PdfFile pdf, int pagenb)
        {
            ...
            else
            {
                ...
                pdf.CenterTextAtPosition(headImgHeight + 60, new PdfTextItem(string.Format("{0}      {1}      www.gloziksoft.sk", this.DataModel.Eshopgloziksoft.Phone, this.DataModel.Eshopgloziksoft.Email), PdfFonts.F_BOLD_11));
    ...
    public class CategoryOfferModel
    {
        ...
        public SysConstModel Eshopgloziksoft { get; private set; }
        ...
        public CategoryOfferModel(Guid pkCaregory, string imgPath)
        {
            ...
            this.Eshopgloziksoft = SysConstModel.CreateCopyFrom(new SysConstRepository().Get());
            this.CategoryData = CategoryModel.CreateCopyFrom(new EshopgloziksoftCategoryRepository().Get(pkCaregory));
            ...
            Page<EshopgloziksoftProduct> productsPage = new EshopgloziksoftProductRepository().GetPage(
                        page: 1,
