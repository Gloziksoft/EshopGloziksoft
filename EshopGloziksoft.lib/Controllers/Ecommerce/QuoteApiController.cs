    ...
    public class QuoteApiController : _BaseApiController
    {
        ...
        public Api_AddToBasketInfo AddProductToQuote(string id)
        {
            try
            {
                ...
                EshopgloziksoftProduct product = InsertProduct2QuoteModel.AddProductToQuote(quote.pk, new Guid(pkProduct), cnt);
            ...
            try
            {
                ...
                if (quoteKey != null && quoteKey != Guid.Empty)
                {
                    ...
                    if (quoteItems.Count > 0)
                    {
                        ...
                        List<EshopgloziksoftProduct> productList = prodRep.GetPageForQuote(1, _PagingModel.AllItemsPerPage, quote.pk).Items;
