...
namespace eshopgloziksoft.lib.Controllers.Ecommerce
{
    ...
    public class QuoteAdminProductController : _BaseController
    {
        ...
        public ActionResult SaveNewRecord(InsertProduct2QuoteModel model)
        {
            ...
            return this.RedirectToEshopgloziksoftUmbracoPage(ConfigurationUtil.EcommerceQuotesEditFormId, string.Format("id={0}&tab={1}", model.PkQuote, QuoteEditModel.TabItemsId));
        }
