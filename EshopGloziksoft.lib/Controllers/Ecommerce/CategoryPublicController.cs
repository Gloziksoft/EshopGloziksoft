...
namespace eshopgloziksoft.lib.Controllers.Ecommerce
{
    ...
    public class CategoryPublicController : _BaseController
    {
        ...
        {
            CategoryModel model = CategoryModel.CreateCopyFrom(new EshopgloziksoftCategoryRepository().GetForCategoryCode(categoryCode));
        ...
        public ActionResult QuickOrder(string categoryCode)
        {
            ...
            return Redirect(CategoryModel.CreateCopyFrom(EshopgloziksoftCategory.RootEshopgloziksoftCategory()).Url);
        }
