...
using eshopgloziksoft.lib.Tasks;
...
namespace eshopgloziksoft.lib.Controllers.Ecommerce
{
    ...
    public class QuoteAdminController : _BaseController
    {
        ...
        public ActionResult DeleteRecord(QuoteModel model)
        {
            ...
            return this.RedirectToEshopgloziksoftUmbracoPage(ConfigurationUtil.EcommerceQuotesFormId);
        }
        ...
        public ActionResult SaveState(QuoteModel model)
        {
            ...
            return this.RedirectToEshopgloziksoftUmbracoPage(ConfigurationUtil.EcommerceQuotesEditFormId, string.Format("id={0}&tab={1}", model.pk, QuoteEditModel.TabStateId));
        }
        ...
        public ActionResult SaveUser(User2QuoteModel model)
        {
            ...
            return this.RedirectToEshopgloziksoftUmbracoPage(ConfigurationUtil.EcommerceQuotesEditFormId, string.Format("id={0}&tab={1}", model.PkQuote, QuoteEditModel.TabUserId));
        }
        ...
        public ActionResult SendInfo(QuoteSendInfoModel model)
        {
            ...
            try
            {
                ...
                QuoteNotifier.SendQuoteStateNotification(model.pk, this.DefaultImgPath, false, notifyEshopgloziksoft: false, moreInfo: model.Note);
